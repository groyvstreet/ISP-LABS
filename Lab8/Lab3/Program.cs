...
namespace Lab8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ((Gangster)people[0]).OnTheft += () => statistic.RaiseAutoThefts();
            ((Police)people[1]).OnArrest += () => statistic.RaiseArrest();
            ((Doctor)people[2]).OnHeal += delegate ()
            {
                statistic.RaiseTreatments();
            };
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("No definition of this argument");
                }
                ...
                switch (input)
                {
                    ...
                    case "4":
                        Console.WriteLine("Cars are thefted - " + statistic.AutoThefts);
                        Console.WriteLine("Amount of arrest - " + statistic.Arrest);
                        Console.WriteLine("Amount of treatments - " + statistic.Treatments + "\n");
                        break;
                }
            }
        }
